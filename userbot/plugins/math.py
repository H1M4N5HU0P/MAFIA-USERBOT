...
@mafiabot.on(admin_cmd(pattern="cos ?(.*)"))
@mafiabot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@mafiabot.on(admin_cmd(pattern="tan ?(.*)"))
@mafiabot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@mafiabot.on(admin_cmd(pattern="cosec ?(.*)"))
@mafiabot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@mafiabot.on(admin_cmd(pattern="sec ?(.*)"))
@mafiabot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@mafiabot.on(admin_cmd(pattern="cot ?(.*)"))
@mafiabot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@mafiabot.on(admin_cmd(pattern="square ?(.*)"))
@mafiabot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@mafiabot.on(admin_cmd(pattern="cube ?(.*)"))
@mafiabot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
