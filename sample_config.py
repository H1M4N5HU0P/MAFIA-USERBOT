...
class Config(object):
    ...
    ALIVE_MSG = os.environ.get("ALIVE_MSG", "ʟɛɢɛռɖaʀʏ ᴀғ ᴍᴀғɪᴀʙᴏᴛ")
    ALIVE_PIC = os.environ.get("ALIVE_PIC", "https://telegra.ph/file/5ad6ab61de5838b16342a.mp4")
    ...
    if AUTH_TOKEN_DATA != None:
        ...
        t_file.close()
    BIO_MSG = os.environ.get("BIO_MSG", "༆ʟɛɢɛռɖaʀʏ ᴀғ ᴍᴀғɪᴀʙᴏᴛ༆")
    ...
    PMPERMIT_PIC = os.environ.get("PMPERMIT_PIC", "https://telegra.ph/file/5ad6ab61de5838b16342a.mp4")
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "D3vilBot")
    TEMP_DIR = os.environ.get("TEMP_DIR", None)
    TMP_DOWNLOAD_DIRECTORY = os.environ.get("TMP_DOWNLOAD_DIRECTORY", "./DOWNLOADS/")
    TZ = os.environ.get("TZ", "Asia/Kolkata")
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/Mafia/MAFIABOT")
